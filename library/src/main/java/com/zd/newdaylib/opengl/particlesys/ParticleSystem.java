package com.zd.newdaylib.opengl.particlesys;

import android.opengl.GLES20;

import com.zd.newdaylib.GlobalConstant;
import com.zd.newdaylib.opengl.Renderable;
...
public class ParticleSystem implements Renderable {
    ...
    public ParticleSystem(ParticleSystemRenderer renderer, FloatBuffer vertexBuffer) {
        ...
        glBufferData(GL_ARRAY_BUFFER, vertexBuffer.capacity() * GlobalConstant.BYTES_PER_FLOAT, vertexBuffer, GL_STATIC_DRAW);
    ...
    @Override
    public void render() {
        final int stride = GlobalConstant.BYTES_PER_FLOAT
        ...
        GLES20.glVertexAttribPointer(mRenderer.textureCoordinateHandle,
                ...
                false,
                stride,
                GlobalConstant.BYTES_PER_FLOAT * (POS_DATA_SIZE)
        );
        ...
        GLES20.glVertexAttribPointer(mRenderer.miscHandle,
                ...
                false,
                stride,
                GlobalConstant.BYTES_PER_FLOAT * (POS_DATA_SIZE + TEXTURE_COORDS_DATA_SIZE)
        );
