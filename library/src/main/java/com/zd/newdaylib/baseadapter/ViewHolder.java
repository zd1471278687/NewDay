package com.zd.newdaylib.baseadapter;
...
public class ViewHolder extends RecyclerView.ViewHolder  {
    ...
    public ViewHolder setNdImageUrl(int viewId, String url) {
        NdImageView ndImageView = getView(viewId);
        ndImageView.setImageURL(url);
        return this;
    }
