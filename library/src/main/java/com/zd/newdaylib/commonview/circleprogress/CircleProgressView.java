package com.zd.newdaylib.commonview.circleprogress;
...
public class CircleProgressView extends View {
    ...
    private List<CircleProgressViewListener> listeners;
    ...
    public void setIndeterminate(boolean isIndeterminate) {
        ...
        if (old != isIndeterminate) {
            for (CircleProgressViewListener listener : listeners) {
    ...
    /**
     * Register a CircleProgressViewListener with this View
     *
     * @param listener The listener to register
     */
    public void addListener(CircleProgressViewListener listener) {
        if (listener != null)
            listeners.add(listener);
    }

    /**
     * Unregister a CircleProgressViewListener with this View
     *
     * @param listener The listener to unregister
     */
    public void removeListener(CircleProgressViewListener listener) {
